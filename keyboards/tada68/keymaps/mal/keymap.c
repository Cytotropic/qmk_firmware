...
// LAYERZ
#define _WBL 0 // Windows Base Layer (_WBL)
#define _MFL 1 // Mac Function Layer (_MFL)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |----------------------------------------------------------------|
   * |LSHFT   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .| /|RSHFT|Up|TG(MFL)|
   * |----------------------------------------------------------------|
...
[_WBL] = KEYMAP_ANSI(
  KC_GRV, KC_1 , KC_2 , KC_3 ,  KC_4 , KC_5 , KC_6 , KC_7 , KC_8 , KC_9 , KC_0 , KC_EQL , KC_MINS , KC_BSPC,KC_ESC,\
   ...
   * |CAPS   |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;| '|Return|PGUP  |
   * |----------------------------------------------------------------|
   * |LSHFT   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .| /|RSHFT|Up|TG(WBL)|
   * |----------------------------------------------------------------|
...
[_MFL] = KEYMAP_ANSI(
  ...
  KC_LCTL, KC_LALT, KC_LGUI,               KC_SPC,                          KC_RGUI, _______,KC_RALT,   KC_LEFT, KC_DOWN,  KC_RGHT),
