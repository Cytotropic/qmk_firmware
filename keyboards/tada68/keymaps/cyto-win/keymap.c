...
[_WBL] = KEYMAP_ANSI(
  ...
  LT(2,KC_CAPS), KC_A,  KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,  KC_QUOT,     KC_ENT     ,  TG(3), \
...
[_FL] = KEYMAP_ANSI(
 ...
 _______,  _______,_______,_______,_______,_______,_______,KC_LBRC, KC_RBRC, _______ , _______ ,_______, KC_PSCR,_______,  \
 ...
 _______,_______,_______,                 TO(2),               _______, _______, KC_BTN1,   KC_MS_L,   KC_MS_D,  KC_MS_R),
   ...
   * |Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|  \  |Del |
   * |----------------------------------------------------------------|
   * |CAPS   |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;| '|Return|TG(2) |
   * |----------------------------------------------------------------|
