...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
[_MBL] = KEYMAP_ANSI(
  KC_GRV, KC_1 , KC_2 , KC_3 , KC_4 , KC_5 , KC_6 ,TD(TDM_7),TD(TDM_8),TD(TDM_9),TD(TDM_10), TD(TDM_11), TD(TDM_12), KC_BSPC,KC_ESC,\
   ...
   * |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|Shift | Up|PgDn|
   * |----------------------------------------------------------------|
   * |Win|Alt |Ctrl |        Space         |Ctrl|M_WIN|Alt|Lef|Dow|Rig|
   * `----------------------------------------------------------------'
   */

[_WFL] = KEYMAP_ANSI(
  KC_GRV, KC_1 , KC_2 , KC_3 ,  KC_4 , KC_5 , KC_6 ,TD(TDW_7),TD(TDW_8),TD(TDW_9),TD(TDW_10), TD(TDW_11), TD(TDW_12), KC_BSPC,KC_ESC,\
  KC_TAB,   KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,    KC_P,     KC_LBRC,   KC_RBRC,  KC_BSLS, KC_DEL, \
   ...
   * |       |   |   |   |   |   |   |   |   |   |   |   |       |    |
   * |----------------------------------------------------------------|
   * |        |   |   |BL_DEC|BL_TG|BL_INC|  |  | |  | |BTN1|MS_U|BTN2|
   * |----------------------------------------------------------------|
   * |   |    |     |                      |   |   |   |MS_L|MS_D|MS_R|
   * `----------------------------------------------------------------'
   */
